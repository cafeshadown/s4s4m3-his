...
<body>
<script type="text/javascript" src="<%=basePath%>js/medicine.js"></script>
<table id="dg" title="员工管理" class="easyui-datagrid" style="width:100%; height: 585px"
       url="<%=basePath%>medicine/medicinelist" toolbar="#toolbar" pagination="true" rownumbers="true"
       fitcolumns="true" singleselect="true">
    <thead>
    <tr>
        <th field="mid" width="50">
           药品编号
        </th>
        <th field="mrname" width="50">
            药品品牌
        </th>
        <th field="mname" width="50">
            药品名称
        </th>
        <th field="mcount" width="50">
            药品数量
        </th>
        <th field="maddress" width="50">
           供应商
        </th>
        <th field="kid" width="50">
            种类
        </th>
        <th field="kname" width="50">
            药品类别
        </th>
    </tr>
    </thead>
