...
<table id="dg" title="员工管理" class="easyui-datagrid" style="width:100%; height: 585px"
       url="<%=basePath%>emp/employeelist?seachname=" toolbar="#toolbar" pagination="true" rownumbers="true"
    ...
    <tr>
        ...
        <th field="pid" width="50">
            部门编号
        </th>
        <th field="did" width="50">
            职位编号
        </th>
        <th field="ename" width="50">
            职工名称
        </th>
        <th field="egender" width="50">
           性别

        </th>
        <th field="ebirth" width="50">
            出生日期

        </th>
        <th field="ephone" width="50">
            电话号
        </th>
    </tr>
    </thead>
